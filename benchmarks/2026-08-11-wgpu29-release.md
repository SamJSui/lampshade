...
benchmark evidence, documentation, a release-harness unit-test scoping fix, and
rustfmt-only nested-harness edits; no Cargo dependency, executable semantics,
Rust kernel, or WGSL changed.
